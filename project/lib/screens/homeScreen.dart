...
class _HomePageState extends State<HomePage> {
  ...
  List mySmartDevices = [
    ["Bedroom", "assets/icons/bedroom.png", true],
    ["Bathroom", "assets/icons/bathroom.png", false],
    ["Livingroom", "assets/icons/livingroom.png", false],
    ["Kitchen", "assets/icons/kitchen.png", false],
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.camera_alt_outlined, color: Color.fromRGBO(65, 176, 110, 1)),
            onPressed: () {
              Navigator.push(
                context,
